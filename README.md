# 📈🧪 Data Analytics Program 🧠📊 : Story of *Alidu Abubakari*
...
🎯 My future is filled with exciting tech aspirations! 🌟💻 I'm set to dive into the world of MLOPs and Full Stack Data Science 🚀📊, merging cutting-edge machine learning with seamless deployment. 🤖🚀 Building on my project portfolio 📁, I'll craft innovative solutions that push the boundaries of data analytics. 🏗️💡 The path ahead is limitless, and I'm ready to embrace every challenge with passion and determination! 🔥🌌 Let's create a tech-tastic future together! 🤝💻🔮

## What is my dream company or role ?

🚀 My dream is to lead a pioneering data science team at a forward-thinking company! 🌟💼 With my expertise in MLOps, Data Science, and Cloud Computing, I envision transforming data into actionable insights 📊💡, while seamlessly integrating machine learning models into real-world applications. 🤖📈 Being at the forefront of technological innovation 🌌🔮 and making a tangible impact on the organization's success is what fuels my passion! 🔥💻 Let's turn this dream into reality together! 🌟🤝🚀
...
|---|-----------------------|-------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| 1 | Sales Dashboard       | Built a sales dashboard with Power BI from the Awesome Chocolate Cookies Data.                           | The project was a peer group assignment. We worked together to combine the given data and build visualizations using guides and resources provided by Azubi. |
| 2 | SQL Queries           | This was an individual assignment in the program. We were asked to answer business questions from the Microsoft Shipping Data using SQL queries. | This project introduced me to the vast possibilities of SQL and demonstrated the immense power of this tool. |
| 3 | Caesar Encryption     | Built the Caesar cipher program with python which is a basic encryption technique that shifts letters in a message by a fixed number of positions in the alphabet. | This project helped us to combine our skills in python function and list indexing. |
| 4 | Bike Buyers Analysis  | To use MS Excel for analysis and build a dashboard.                                                      | Conducted a comprehensive analysis of Bike Buyers data using MS Excel and created an insightful dashboard for key metrics and trends. |
...
|---------|-----------------------------------------------|--------------------------------------------------------------------------------------------------------------------|---------|-----------------------|-----------------|-----------------|
| 1       | Indian Startup Ecosystem Analysis            | This analysis is to give insight to entrepreneurs who are seeking to venture into the Indian start-up ecosystem by highlighting key metrics to consider before venturing.  | [Article](https://medium.com/@alidu143/indian-startup-ecosystem-a-data-visualization-approach-to-understanding-which-industry-is-more-703072cf0e31) | None                  | None            | [Project Repo](https://github.com/aliduabubakari/Indian-Startup-Data-Visualization.git)     |
| 2       | Store Sales Time Series Forecasting          | To build a model and an app that more accurately predicts the unit sales for thousands of items sold at different Favorita stores.  | [Article](https://medium.com/@alidu143/forecasting-future-sales-for-corporaci%C3%B3n-favorita-grocery-unlocking-the-potential-of-predictive-c86d719382ea) | [App with Streamlit](https://huggingface.co/spaces/Abubakari/Sales_Prediction)    | [App Repo](https://github.com/aliduabubakari/Streamlit-grocery-sales-prediction-app.git)        | [Project Repo](https://github.com/aliduabubakari/Forecasting-Future-Sales-for-Corporaci-n-Favorita-Grocery.git)     |
| 3       | Telcom Customer Churn Prediction             | To build a model and an app to predict customer churn in a Telcom company.                                         | [Article](https://medium.com/@alidu143/building-a-customer-churn-prediction-web-app-with-gradio-a-step-by-step-guide-5d7d77ede323) | [App with Gradio](https://huggingface.co/spaces/Abubakari/churn_prediction_App)       | [App Repo](https://github.com/aliduabubakari/churn-prediction-with-gradio.git)        | [Project Repo](https://github.com/aliduabubakari/Telco-Customer-Churn.git)    |
